...
// This can be loaded and inserted via JavaScript if needed, but for now we'll embed directly in each page
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="nav-menu" id="navMenu">
                <li class="nav-item"><a href="/tech" class="nav-link">Tech</a></li>
